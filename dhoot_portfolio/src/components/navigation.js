    ...
    render() {
        return(
            <div className="col-xs-12 col-sm-10 offset-sm-1 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                <div className="menubox justify-content-center ">
                    <h2 class="textyellow textspaced"><u>Select Directory</u></h2>
                    ...
                    <ul className="navbar-nav">
                        ...
                        <li className="nav-item textspaced" id="START" onClick={this.handleClick}>Reboot</li>
                    </ul>
                </div>
            </div>
        )
