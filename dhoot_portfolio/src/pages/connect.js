    ...
    return (
      <div className="col-12 row justify-content-center ml-0 mr-0 pl-0 pr-0">
        <div className="col-lg-3 col-xs-12 socialbox text-center shadow-lg pt-5 mb-4 mr-3 ml-3">
          ...
          <a
            href="https://github.com/Manmeetdhoot"
            target="_blank"
            rel="noreferrer"
        ...
        <div className="col-lg-3 col-xs-12 socialbox text-center shadow-lg pt-5 mb-4 mr-3 ml-3">
          ...
          <a
            href="mailto:manmeetkaurdhoot@gmail.com"
            target="_blank"
            rel="noreferrer"
            className="socialicon-large"
          >
        ...
        <div className="col-lg-3 col-xs-12 socialbox text-center shadow-lg pt-5 mb-4 mr-3 ml-3">
          ...
          <a
            href="https://www.linkedin.com/in/manmeet-kaur-dh00t/"
            target="_blank"
            rel="noreferrer"
            className="socialicon-large"
          >
          ...
          <hr className="navbreak" />
          <p className="text-white raleway pt-4">
            Want to share network? <br /> Reach out on LinkedIn.
          </p>
        </div>
      </div>
    );
